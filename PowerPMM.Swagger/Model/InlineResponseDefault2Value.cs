...
{
    /// <summary>
    /// InlineResponseDefault2Value
    /// </summary>
    [DataContract]
        public partial class InlineResponseDefault2Value :  IEquatable<InlineResponseDefault2Value>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponseDefault2Value" /> class.
        /// </summary>
        ...
        public InlineResponseDefault2Value(string odataEtag = default(string), decimal? entryNo = default(decimal?), decimal? sourceType = default(decimal?), string sourceSystemId = default(string), bool? requireContent = default(bool?), string name = default(string), string extension = default(string), string attachmentID = default(string), string base64Content = default(string), string attachmentUrl = default(string))
        {
        ...
        {
            return this.Equals(input as InlineResponseDefault2Value);
        }

        /// <summary>
        /// Returns true if InlineResponseDefault2Value instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponseDefault2Value to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseDefault2Value input)
        {
            if (input == null)
                return false;
