...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponseDefault16Value :  IEquatable<InlineResponseDefault16Value>, IValidatableObject
    {
        ...
        /// <param name="interchangeable">interchangeable.</param>
        /// <param name="condition">condition.</param>
        public InlineResponseDefault16Value(string odataEtag = default(string), string systemId = default(string), string no = default(string), string variantCode = default(string), string substituteNo = default(string), string substituteVariantCode = default(string), string description = default(string), bool? interchangeable = default(bool?), bool? condition = default(bool?))
        {
        ...
        /// interchangeable
        /// </summary>
        /// <value>interchangeable</value>
        [DataMember(Name="interchangeable", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Interchangeable: ").Append(Interchangeable).Append("\n");
        ...
        public bool Equals(InlineResponseDefault16Value input)
        {
            ...
            return 
                ...
                (
                    this.Interchangeable == input.Interchangeable ||
                    (this.Interchangeable != null &&
                    this.Interchangeable.Equals(input.Interchangeable))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Interchangeable != null)
                    hashCode = hashCode * 59 + this.Interchangeable.GetHashCode();
