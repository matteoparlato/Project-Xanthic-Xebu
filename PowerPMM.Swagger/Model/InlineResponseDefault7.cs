...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponseDefault7 :  IEquatable<InlineResponseDefault7>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponseDefault7(string odataContext = default(string), List<InlineResponseDefault7Value> value = default(List<InlineResponseDefault7Value>))
        {
        ...
        public List<InlineResponseDefault7Value> Value { get; set; }
        ...
        {
            return this.Equals(input as InlineResponseDefault7);
        }

        /// <summary>
        /// Returns true if InlineResponseDefault7 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponseDefault7 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseDefault7 input)
        {
            if (input == null)
                return false;
