...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponseDefault24Value :  IEquatable<InlineResponseDefault24Value>, IValidatableObject
    {
        ...
        public InlineResponseDefault24Value(string odataEtag = default(string), string systemId = default(string), string faultAreaCode = default(string), string code = default(string), string description = default(string))
        {
