...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponseDefault9 :  IEquatable<InlineResponseDefault9>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponseDefault9(string odataContext = default(string), List<InlineResponseDefault9Value> value = default(List<InlineResponseDefault9Value>))
        {
        ...
        public List<InlineResponseDefault9Value> Value { get; set; }
        ...
        {
            return this.Equals(input as InlineResponseDefault9);
        }

        /// <summary>
        /// Returns true if InlineResponseDefault9 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponseDefault9 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseDefault9 input)
        {
            if (input == null)
                return false;
