...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class InlineResponseDefault8 :  IEquatable<InlineResponseDefault8>, IValidatableObject
    {
        /// <summary>
        ...
        public InlineResponseDefault8(string odataContext = default(string), List<InlineResponseDefault8Value> value = default(List<InlineResponseDefault8Value>))
        {
        ...
        public List<InlineResponseDefault8Value> Value { get; set; }
        ...
        {
            return this.Equals(input as InlineResponseDefault8);
        }

        /// <summary>
        /// Returns true if InlineResponseDefault8 instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponseDefault8 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponseDefault8 input)
        {
            if (input == null)
                return false;
