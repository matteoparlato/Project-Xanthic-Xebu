...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponseDefault31Value :  IEquatable<InlineResponseDefault31Value>, IValidatableObject
    {
        ...
        public InlineResponseDefault31Value(string odataEtag = default(string), string systemId = default(string), string status = default(string), string prodOrderNo = default(string), string routingNo = default(string), decimal? routingReferenceNo = default(decimal?), string operationNo = default(string), decimal? lineNo = default(decimal?), string no = default(string), string description = default(string))
        {
