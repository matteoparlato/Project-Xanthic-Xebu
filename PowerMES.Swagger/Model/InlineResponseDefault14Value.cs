...
namespace IO.Swagger.Model
{
        ...
        public partial class InlineResponseDefault14Value :  IEquatable<InlineResponseDefault14Value>, IValidatableObject
    {
        ...
        public InlineResponseDefault14Value(string odataEtag = default(string), string systemId = default(string), string no = default(string), string description = default(string), string itemNo = default(string), string variantCode = default(string))
        {
